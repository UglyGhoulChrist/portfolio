(() => {
    ...
    const pageSwiper = new core(".swiper-page", {
        ...
        watchOverflow: true,
        speed: 800,
        wrapperClass: "swiper-wrapper-page",
        direction: "vertical",
        keyboard: {
            enabled: true,
            onlyInViewport: true,
        ...
        pagination: {
            ...
            clickable: true,
            type: "bullets",
            bulletClass: "swiper-pagination-page__bullet",
            bulletActiveClass: "swiper-pagination-page__bullet_active"
        },
        on: {
            init: function() {
                menuSlider();
    ...
    const skillsSwiper = new core(".swiper-skills", {
        ...
        autoHeight: false,
        speed: 800,
        wrapperClass: "swiper-wrapper-skills",
        direction: "horizontal",
        loop: true,
        autoplay: {
            delay: 3e3,
        ...
        pagination: {
            ...
            clickable: true,
            type: "bullets",
            bulletClass: "swiper-pagination-skills__bullet",
            bulletActiveClass: "swiper-pagination-skills__bullet_active"
        },
        breakpoints: {
            320: {
                slidesPerView: 1
    ...
    const projectsSwiper = new core(".swiper-projects", {
        ...
        pagination: {
            ...
            clickable: true,
            type: "bullets",
            bulletClass: "swiper-pagination-projects__bullet",
            bulletActiveClass: "swiper-pagination-projects__bullet_active"
        },
        breakpoints: {
            768: {
                slidesPerView: 2,
    ...
    function showFooter() {
        if (menuLinks.length > 0) if (pageSwiper.realIndex == menuLinks.length - 1) footerBlock.classList.add("_showFooter"); else footerBlock.classList.remove("_showFooter");
    }
    ...
    function settingPosition() {
        const heightImg = document.getElementById("height-img").offsetHeight;
        const paginationProjects = document.getElementById("swiper-pagination-projects");
        paginationProjects.style.top = heightImg + 20 + "px";
    }
    function setScrollType() {
        if (body.classList.contains("_free")) {
            body.classList.remove("_free");
        ...
        for (let index = 0; index < pageSwiper.slides.length; index++) {
            ...
            if (pageSlide) if (pageSlide.offsetHeight > window.innerHeight) {
                body.classList.add("_free");
    ...
    window.addEventListener("load", (function(e) {
        ...
        formName.oninput = function() {
            if (formName.value) resultName.textContent = formName.value; else resultName.textContent = formName.placeholder;
        };
        formEmail.oninput = function() {
            if (formEmail.value) resultEmail.textContent = formEmail.value; else resultEmail.textContent = formEmail.placeholder;
        };
        formMessage.oninput = function() {
            if (formMessage.value) resultMessage.textContent = formMessage.value; else resultMessage.textContent = formMessage.placeholder;
        };
        newDate.textContent = (new Date).toLocaleDateString();
    }));
    window["FLS"] = false;
    isWebp();
    menuInit();

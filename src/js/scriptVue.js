    ...
    return {
      skillList: [
        ...
        },
        {
          ...
          description:
            "Фреймворк для веб-приложений на языке Python (Пока только изучаю)",
        },
        {
          name: "JavaScript",
        ...
        },
        {
          ...
          description: "JS-библиотека для разработки UI (Следующий в изучении)",
        },
      ],
    };
  },
  ...
  data() {
    return {
      aboutText: [
        ...
        "Сейчас изучаю Django и посматриваю в сторону React.",
